...
var foodqty = document.querySelector('.foodqty');
var foodpr = document.querySelector('.food-pr');
var foodamt = document.querySelector('.food-amt');

function addCart(food) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/add-cart', food).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
    toastr__WEBPACK_IMPORTED_MODULE_1___default().success('Item Added To Cart 🔥');
  })["catch"](function (err) {
    console.error(err);
    toastr__WEBPACK_IMPORTED_MODULE_1___default().warning('Something Went Wrong 👀');
  });
}
...
function removeCart(food) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/remove-cart', food).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
    toastr__WEBPACK_IMPORTED_MODULE_1___default().success('Item Removed From Cart 😐');
  })["catch"](function (err) {
    toastr__WEBPACK_IMPORTED_MODULE_1___default().warning('Something Went Wrong 👀');
  });
}
